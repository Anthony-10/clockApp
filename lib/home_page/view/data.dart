...
import 'package:clock_app/home_page/view/alarm_info.dart';
...
List<AlarmInfo> alarms = [
  ...
  AlarmInfo(DateTime.now().add(Duration(hours: 1)), description: 'Sports', gradientColors: GradientColors.sunset)
